                ...
                <div class="col-md-6 text-md-end">
                    <div class="user-nav small">
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <a href="/account" class="text-white me-3">
                        ...
                        <?php else: ?>
                            <a href="/login" class="text-white me-3">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-3 col-6 order-md-3 order-2 text-end">
                    <div class="header-actions">
                        <a href="/wishlist" class="btn btn-outline-secondary me-2" title="Wishlist">
                            <i class="far fa-heart"></i>
                        </a>
                        <a href="/cart" class="btn btn-outline-primary position-relative" title="Shopping Cart">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle <?php echo ($current_page == 'products.php' || $current_page == 'categories.php') ? 'active' : ''; ?>" 
                           href="/products" id="navbarDropdownProducts" role="button" 
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownProducts">
                            ...
                            ?>
                                <li><a class="dropdown-item" href="/products?category=<?php echo $category['id']; ?>"><?php echo $category['name']; ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($current_page == 'quarry.php') ? 'active' : ''; ?>" href="/quarry">Our Quarry</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($current_page == 'mission.php') ? 'active' : ''; ?>" href="/mission">Our Mission</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($current_page == 'contacts.php') ? 'active' : ''; ?>" href="/contacts">Contact Us</a>
                    </li>
                </ul>
            </div>
        </div>
